...
const translations = {
  ...
  'Soon': 'בקרוב',
    ...
    'No tasks found for the current search/filter.': 'לא נמצאו משימות עבור החיפוש/סינון הנוכחי.',
    'Status': 'סטטוס',
    'Recurring': 'חוזר',
    'Due': 'תאריך יעד',
    'Time': 'שעה',
  ...
  en: {
    ...
    'No tasks found for the current search/filter.': 'No tasks found for the current search/filter.',
    'Status': 'Status',
    'Recurring': 'Recurring',
    'Due': 'Due',
    'Time': 'Time',
